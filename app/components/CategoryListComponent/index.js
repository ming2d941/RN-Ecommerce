...
import {View,Dimensions,Image,FlatList,Text,TouchableOpacity} from 'react-native';
...
const renderItem = ({ item, index}) => {
    return (
      <TouchableOpacity>
    <View style={{  width:devicewidth,margin: 1,justifyContent: 'center',alignItems: 'center',height:120 }}>
        <Image style={{height: 70,width:70,borderRadius:60}} 
